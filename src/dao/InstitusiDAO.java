...
public class InstitusiDAO {
    ...
    public List<Institusi> getAll() throws SQLException {
        String sql = "SELECT id_institusi, nama, alamat FROM institusi ORDER BY nama";
    ...
    public Institusi getById(int id) throws SQLException, DataTidakDitemukanException {
        String sql = "SELECT id_institusi, nama, alamat FROM institusi WHERE id_institusi = ?";
        try (Connection c = Koneksi.getConnection();
             PreparedStatement ps = c.prepareStatement(sql)) {
            ps.setInt(1, id);
    ...
    public int insert(Institusi inst) throws SQLException {
        String sql = "INSERT INTO institusi (nama, alamat) VALUES (?, ?)";
        try (Connection c = Koneksi.getConnection();
